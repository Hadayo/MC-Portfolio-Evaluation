...
dt = 1 / 365
strategist = pt.ConstantCRRAStrategy(R=0.5, dt=dt)
...
if online:
    ...
    for t in range(num_points):
        information, secret_information = market_simulator.step()
        positions, port_val = trader.step(information, secret_information)
...
if batch:
    ...
    trader.reset()
    information, secret_information = market_simulator.sample_path(T)
    positions, port_vals = trader.compute_path(information, secret_information)
